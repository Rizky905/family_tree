                ...
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        <div class="card-body">
                            ...
                            <form action="{{route('register')}}" method="POST" role="form text-left" id="formSignUp">
                                @csrf
                                ...
                                <div class="mb-3">
                                    <input name="email" wire:model="email" type="email" class="form-control" placeholder="Email"
                                            aria-label="Email" aria-describedby="email-addon">
                                </div>
                                <div class="mb-3">
                                    <input name="password" wire:model="password" type="password" class="form-control"
